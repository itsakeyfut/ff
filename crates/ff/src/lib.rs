...
//!
//! `ff` is the facade crate for the ff-* crate family. It re-exports the public
//! APIs of all member crates behind feature flags, so users can depend on a single
//! crate and opt into only the functionality they need.
//!
//! # Status
//!
